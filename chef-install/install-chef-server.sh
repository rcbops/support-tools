...
EOF
    ...
    knife cookbook upload -o ${HOMEDIR}/chef-cookbooks/cookbooks -a !/bin/bash
#
# Copyright 2013 Rackspace US, Inc
#
# Licensed under the Apache License, Version 2.0 (the "License");
...
EOF
    ...
    knife environment from_file ${ENVFILE:-env.json}
fi#!/bin/bash
#
# Copyright 2013 Rackspace US, Inc
#
...
EOF
    ...
    # attempt to reload cookbooks/roles/environment, don't bomb if they fail
